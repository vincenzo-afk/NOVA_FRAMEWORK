...
| `provider.health_changed` | Model Router | `provider_id`, `from_state`, `to_state` (per FM-04 circuit-breaker states) |
...
| `sync.conflict_detected` | Sync Engine | `record_id`, `device_a`, `device_b`, `resolution` |
