...
- **Planned** — documented/designed but not yet implemented; referencing
  it as available is a documentation bug (see "Where This Breaks" below).
...
- `docs/14-development/feature-flags.md` — how `Experimental` features
  are typically gated in code
