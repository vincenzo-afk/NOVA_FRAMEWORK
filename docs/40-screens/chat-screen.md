...
Focus order, screen-reader labels, and reduced-motion behavior follow `docs/30-design/accessibility.md`; keyboard-only navigation must reach every action on this screen without a mouse.
