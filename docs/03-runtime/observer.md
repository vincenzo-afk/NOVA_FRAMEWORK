...
applications, windows, browser, clipboard, terminal, git, containers —
each detailed in `docs/07-observers/`, Tier 3) are built on: registration,
permission gating, and event normalization. This document covers what is
common to every observer; source-specific detail lives in Tier 3.
