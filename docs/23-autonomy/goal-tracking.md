...
- `docs/04-memory/ontology.md` (v2) — the Goal node and `pursues` /
  `advances` / `blocks` edges this document relies on
- `background-life-assistant.md` — the scheduling and briefing-delivery
