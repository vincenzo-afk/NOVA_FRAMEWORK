...
Update applied without a compatibility check against `26-system-reference/09-version-compatibility-matrix.md`; no rollback path if the new version fails its first-boot self-check.
